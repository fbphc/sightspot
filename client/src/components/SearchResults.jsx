            ...
            return (
              ...
              >
                ...
                >
                  ...
                  >
                    <p className="my-1">
                      <b>{item.original_title === undefined ? item.original_name : item.original_title }</b>
                    </p>
                    <p className="my-1">
                      Type: <b>{item.media_type}</b>
                    </p>
                    <p className="my-1">
                       <b>{item.release_date === undefined || item.release_date === "" ? "-": item.release_date.split("-")[0]}</b>
                    </p>
                    <Link
                      to={`/search_Results/${item.id}`}
                      className="mb-3"
                    >
                      More...
                    </Link>
